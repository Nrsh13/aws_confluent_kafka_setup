...
INFO: Check if Topic mytopic exists. Else Create it

INFO: Topic mytopic Exists.

INFO: Get json Schema for Topic mytopic
...
- Running Consumer
```
[root@ansible ~]# python3.9 /tmp/confluent-kafka-any-topic-consumer.py -p json -t mytopic -s ansi-lab01-01.nrsh13-hadoop.com -secure False
